                ...
                !showCart ?
                    (
                        <div className="product-grid">
                            {
                                plantsArray.map((plantsWithCategory, plantsWithCategoryIndex) =>
                                (
                                    <>
                                        <h2>{plantsWithCategory.category}</h2>
                                        <div className="product-list" key={plantsWithCategoryIndex}>

                                            {
                                                plantsWithCategory.plants.map((plant, plantIndex) =>
                                                (
                                                    <div className="product-card" key={plantIndex}>
                                                        ...
                                                        <button
                                                            ...
                                                            onClick={() => addToCart(plantsWithCategoryIndex, plantIndex)}>
                                                            Add to Cart
                                                        </button>
                                                    </div>
                                                ))
